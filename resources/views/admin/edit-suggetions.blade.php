			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><b>Edit Suggetions</b></h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/admin/update-suggetions', $edit_suggetions->id)}}" method="post">
                            @csrf
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xxlarge" name="inst_name" value="{{ $edit_suggetions->inst_name }}">
							  </div>
							</div>
                            <div class="control-group">
                                <label class="control-label" for="date01"><b>Department</b></label>
                                <div class="controls">
                                  <input type="text" class="input-xxlarge" name="dept" value="{{ $edit_suggetions->dept }}">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="date01"><b>Skill</b></label>
                                <div class="controls">
                                  <input type="text" class="input-xxlarge" name="skill" value="{{ $edit_suggetions->skill }}">
                                </div>
                            </div>
                            <div class="control-group">
